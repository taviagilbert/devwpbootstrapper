...
const projectURL = 'devwpbootstrapper.local';
...
const textDomain = 'devwpbootstrapper';

// Name of the translation file.
const translationFile = ' devwpbootstrapper.pot';

// Where to save the translation files.
const translationDestination = './lang';

// Package name.
const packageName = 'devwpbootstrapper';

// Where can users report bugs.
const bugReport = 'https://taviagilbert.dev/contact/';

// Last translator Email ID.
const lastTranslator = 'Tavia Gilbert info@taviagilbert.dev';

// Team's Email ID.
const team = 'Tavia Gilbert info@taviagilbert.dev';
